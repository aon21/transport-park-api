...
class OrderFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $order3->setOrderNumber('ORD-2024-003')
            ...
            ->setFleetSet($this->getReference(FleetSetFixtures::FLEET_SET_WORKS, FleetSet::class));
        ...
        $order5->setOrderNumber('ORD-2024-005')
            ...
            ->setFleetSet($this->getReference(FleetSetFixtures::FLEET_SET_FREE, FleetSet::class));
